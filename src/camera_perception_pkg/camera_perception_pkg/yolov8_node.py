...
class Yolov8Node(LifecycleNode):
    ...
    def __init__(self, **kwargs) -> None:
        ...
        #self.declare_parameter("model", "best.engine")
    ...
    def on_configure(self, state: LifecycleState) -> TransitionCallbackReturn:
        ...
        self._pub1 = self.create_lifecycle_publisher(
            DetectionArray, "detections_1", 10)
        
        self._pub2 = self.create_lifecycle_publisher(
            DetectionArray, "detections_2", 10)
    ...
    def on_activate(self, state: LifecycleState) -> TransitionCallbackReturn:
        ...
        try:
            ...
            self.yolo = YOLO(self.model, task="segment")  # 모델 로딩
            # self.yolo.fuse()
    ...
    def image_cb_1(self, msg: Image) -> None:
        print(msg.header)
        ...
        if self.enable:
            ...
            self._pub1.publish(detections_msg)

            del results
            del cv_image
   
    def image_cb_2(self, msg: Image) -> None:
        print(msg.header)
        ...
        if self.enable:
            ...
            # publish detections
            detections_msg.header = msg.header
            self._pub2.publish(detections_msg)
