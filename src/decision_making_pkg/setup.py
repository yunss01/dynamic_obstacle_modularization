...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'motion_planner_node_module = decision_making_pkg.motion_planner_node_module:main',
            'path_planner_node = decision_making_pkg.path_planner_node:main',
            'path_planner_node_module = decision_making_pkg.path_planner_node_module:main',
        ],
    },
)
